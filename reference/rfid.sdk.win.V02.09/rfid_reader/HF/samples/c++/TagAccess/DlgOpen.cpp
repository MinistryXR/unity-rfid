...
void CDlgOpen::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO1, cbb_COMs);
	DDX_Control(pDX, IDC_COMBO11, m_cbbReaderType);
	DDX_Control(pDX, IDC_COMBO12, m_cbbUsbOpenType);
	DDX_Control(pDX, IDC_COMBO13, m_cbbSerialNum);
	DDX_Control(pDX, IDC_IPADDRESS1, m_ipAddrIP);
	DDX_Control(pDX, IDC_EDIT1, m_netPort);
	DDX_Control(pDX, IDC_COMBO14, m_cbbCommunicationType);
	DDX_Control(pDX, IDC_COMBO2, cbb_baud);
	DDX_Control(pDX, IDC_COMBO3, cbb_frame);
}


BEGIN_MESSAGE_MAP(CDlgOpen, CDialog)
	ON_BN_CLICKED(IDOK, &CDlgOpen::OnBnClickedOk)
	ON_CBN_SELCHANGE(IDC_COMBO11, &CDlgOpen::OnCbnSelchangeCombo11)
	ON_CBN_SELCHANGE(IDC_COMBO12, &CDlgOpen::OnCbnSelchangeCombo12)
	ON_CBN_SELCHANGE(IDC_COMBO14, &CDlgOpen::OnCbnSelchangeCombo14)
