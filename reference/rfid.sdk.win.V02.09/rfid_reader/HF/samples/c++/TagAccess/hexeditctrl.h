/////////////////////////////////////////////////////////////////////////////
// CHexEdit window
#ifndef __HEX_EDIT_H__
#define __HEX_EDIT_H__
...
public:
	...
	int			m_aiu ;				// address increase unit  
	int			m_sa ;				// start address 
...
public:
	...
	int GetData(LPBYTE p, int offset,int len);
	void SetData(LPBYTE p, int len);
	void UpdateData(LPBYTE p,int offset,int len) ;
	CSize GetSel(void);
