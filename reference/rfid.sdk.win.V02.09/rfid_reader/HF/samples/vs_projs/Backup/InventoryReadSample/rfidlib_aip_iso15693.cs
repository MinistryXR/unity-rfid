...
namespace RFIDLIB
{
    class rfidlib_aip_iso15693
    {
        ...
        public static extern Int32 ISO15693_SetInvenReadParam(UIntPtr hIso15693InvenParam, Byte readSecSta, UInt32 blkAddr, UInt32 numOfBlks);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ISO15693_ParseInventoryReadReport(UIntPtr hTagReport, Byte[] uid, ref UInt32 numOfBlocks, Byte[] blkData, ref UInt32 nSize);
        [DllImport("rfidlib_aip_iso15693.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
