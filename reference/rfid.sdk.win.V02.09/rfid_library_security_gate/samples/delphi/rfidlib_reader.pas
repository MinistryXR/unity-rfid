...
//err_t RFIDLIB_API RDR_GetReaderInfor(RFID_READER_HANDLE hr,BYTE Type ,LPTSTR buffer,DWORD *nSize) ;
//function   RDR_GetReaderInfor(hr:longword;infType:Byte;buf:pchar;var nSize :longword) :integer;  stdcall ; external 'rfidlib_reader.dll' ;
// *** ∑≠“Î æ¿˝ ********



function  RDR_GetPassingCounter(hr:longword;var inFlow:longword;var outFlow:longword) :integer; stdcall;external 'rfidlib_reader.dll'
function  RDR_ResetPassingCounter(hr:longword;flag:longword) :integer;stdcall;external 'rfidlib_reader.dll'
function  RDR_SetSystemTime(hr:longword;year:longword;month:Byte;day:Byte;hour:Byte;minute:Byte;secord:Byte):integer;stdcall;external 'rfidlib_reader.dll'
...
function  RDR_ReverseInOutDirection(hr:longword) :integer;stdcall;external  'rfidlib_reader.dll'
